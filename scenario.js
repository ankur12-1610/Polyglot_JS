...
var scenarios = [{ // add the text you'd want should appear on the hacker's card
  hackerCard: {
      description: "I sent you a fake link in mail from unknown website for the purpose of phishing.",
      power: 3,
  },
  ...
  playerCards: [{
          description: "I avoid clicking on any unknown links.",
          power: 5,
      },
      {
          description: "Ohh Shit!! I clicked that fake link.",
          power: 1,
      },
      {
...
},
{
  ...
  hackerCard: {
      description: "I have your official email password.",
      power: 3,
  },
  // add 3 card descriptions you'd want should appear on the player's card. Keeping in mind that at least ONE of them should be an apt counter!
  playerCards: [{
          description: "I frequently change my password but not sure whether did it this time.",
          power: 4,
      },
      {
          description: "I didn't change the password.",
          power: 3,
      },
      {
          description: "I clearly remember that I changed my password so no worries .",
          power: 5,
      }
  ]
}, {
  hackerCard: {
      description: "I want your aadhar card details.",
      power: 3,
  },
  playerCards: [{
          description: "I never share my aaadhar card details.",
          power: 5,
      },
      {
          description: "I will first contact my friends to confirm about it.",
          power: 4,
      },
      {
          description: "I will share my aadhar card details with you.",
          power: 1,
      }
  ]
}
